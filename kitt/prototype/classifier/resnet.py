...
def res_block(x, in_channels, out_channels, strides, name="res_block"):
    """
...
def res_unit(x, in_channels, out_channels, strides, bottleneck, conv1_stride, name="res_unit"):
    """
...
def res_init_block(x, in_channels, out_channels, name="res_init_block"):
    """
    ...
    """
    x = conv7x7_block(
        x=x, in_channels=in_channels, out_channels=out_channels, strides=2, name=name + "/conv"
    )
    x = maxpool2d(x=x, pool_size=3, strides=2, padding=1, name=name + "/pool")
    return x
...
def resnetbc14b(**kwargs):
    ...
    """
    return get_resnet(
        blocks=14, bottleneck=True, conv1_stride=False, model_name="resnetbc14b", **kwargs
    )
...
def resnetbc26b(**kwargs):
    ...
    """
    return get_resnet(
        blocks=26, bottleneck=True, conv1_stride=False, model_name="resnetbc26b", **kwargs
    )
...
def resnetbc38b(**kwargs):
    ...
    """
    return get_resnet(
        blocks=38, bottleneck=True, conv1_stride=False, model_name="resnetbc38b", **kwargs
    )
