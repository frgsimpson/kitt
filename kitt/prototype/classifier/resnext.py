"""
    Code from https://github.com/osmr/imgclsmob/blob/master/keras_/kerascv/models/resnext.py
...
from kitt.prototype.classifier.common import (
    conv1x1_block,
    conv3x3_block,
    is_channels_first,
    flatten
)
from kitt.prototype.classifier.resnet import res_init_block


def resnext_bottleneck(
    x,
    in_channels,
    out_channels,
    strides,
    ...
    x = conv1x1_block(
        x=x, in_channels=in_channels, out_channels=group_width, name=name + "/conv1"
    )
    x = conv3x3_block(
        x=x,
...
def resnext_unit(
    x, in_channels, out_channels, strides, cardinality, bottleneck_width, name="resnext_unit"
):
    """
...
def resnext(
    ...
    """
    input_shape = (
        (in_channels, in_size[0], in_size[1])
        if is_channels_first()
        else (in_size[0], in_size[1], in_channels)
    )
...
def get_resnext(
    ...
    **kwargs,
    ...
    if pretrained:
        raise ("Pretrained CNNs not currently supported."
               "Use model_store.py from the original code if required.")
...
def resnext14_16x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=14, cardinality=16, bottleneck_width=4, model_name="resnext14_16x4d", **kwargs
    )
...
def resnext14_32x2d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=14, cardinality=32, bottleneck_width=2, model_name="resnext14_32x2d", **kwargs
    )
...
def resnext14_32x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=14, cardinality=32, bottleneck_width=4, model_name="resnext14_32x4d", **kwargs
    )
...
def resnext26_16x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=26, cardinality=16, bottleneck_width=4, model_name="resnext26_16x4d", **kwargs
    )
...
def resnext26_32x2d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=26, cardinality=32, bottleneck_width=2, model_name="resnext26_32x2d", **kwargs
    )
...
def resnext26_32x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=26, cardinality=32, bottleneck_width=4, model_name="resnext26_32x4d", **kwargs
    )
...
def resnext38_32x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=38, cardinality=32, bottleneck_width=4, model_name="resnext38_32x4d", **kwargs
    )
...
def resnext50_32x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=50, cardinality=32, bottleneck_width=4, model_name="resnext50_32x4d", **kwargs
    )
...
def resnext101_32x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=101, cardinality=32, bottleneck_width=4, model_name="resnext101_32x4d", **kwargs
    )
...
def resnext101_64x4d(**kwargs):
    ...
    """
    return get_resnext(
        blocks=101, cardinality=64, bottleneck_width=4, model_name="resnext101_64x4d", **kwargs
    )
