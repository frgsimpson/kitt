...
# DATASETS = ["Naval", "Kin8mn", "Boston", "Concrete", "Energy", "Power", "WineRed", "Yacht"] # todo revert this comment
DATASETS = ["WineRed"]
...
def single_run(
    ...
    perform_random_intialisation(model, n_inits=1)
